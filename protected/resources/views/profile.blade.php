...
<html lang="en">
<head>
<title>Toni Kusnandar's Portfolio</title>
<!-- for-mobile-apps -->
...
<!-- gallery -->
<link type="text/css" rel="stylesheet" href="cssP/cm-overlay.css" />

<!-- //gallery -->
<!-- font-awesome icons -->
<link href="cssP/font-awesome.css" rel="stylesheet"> 
...
<!-- banner -->
	<div class="banner">
			<!--Slider-->
			<img src="images/toni1.jpg" alt=" " class="img-responsive">
					<h2>I'M Toni Kusnandar</h2>
		...
		<!--//Slider-->
					<ul class="top-links">
									<li><a href="https://www.facebook.com/tonychoper" target="_blank"><i class="fa fa-facebook"></i></a></li>
									<li><a href="https://twitter.com/T_tokun" target="_blank"><i class="fa fa-twitter"></i></a></li>
									<li><a href="https://www.linkedin.com/in/kusnandartoni" target="_blank"><i class="fa fa-linkedin"></i></a></li>
									<li><a href="https://plus.google.com/u/0/102939527421479222723" target="_blank"><i class="fa fa-google-plus" target="_blank"></i></a></li>
								</ul>
	</div>
<!-- //banner -->
	</div>
			...
			<nav class="navbar navbar-default">
				...
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="logo">
						<h1><a class="navbar-brand" href="index.html"><span class="one">T</span>oni Resume</a></h1>
					</div>
				</div>
	...
	<div class="about" id="about">
		...
		<div class="w3l-grids-about">
				...
				<div class="col-md-7 w3ls-agile-left">
					...
					<div class="w3ls-agile-left-info">
						<h4>Address</h4>
						<p> Jl Masjid 1 GG Jambu No 70A Cinere, Depok, West Java, INA</p>
					</div>
					<div class="w3ls-agile-left-info">
						<h4>Email Address</h4>
						<p><a href="mailto:kusnandartoni@gmail.com">kusnandartoni@gmail.com</a></p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
		     ...
		     <h3 class="w3l_head three">My Education</h3>
			  <div class="education-agile-grids">
				  ...
				  <div class="education-agile-w3l two">
				     <div class="education-agile-w3l-year">
					       <h4>2005-2011</h4>
						   <h6>Junior-Senior Highschool</h6>
				     </div>
					 <div class="education-agile-w3l-info">
					       <h4>Al-Zaytun</h4>
						   <p>7th generation (SWAT)<br>
							Science major with GPA 8.51 / 10<br>
							Read more about my school <a href="http://al-zaytun.sch.id/" target="_blank">Al-Zaytun</a></p>
				...
				<!--  <div class="education-agile-w3l">
				     <div class="education-agile-w3l-year">
					       <h4>2005-2008</h4>
						   <h6>Junior Highschool</h6>
				     </div>
					 <div class="education-agile-w3l-info">
					       <h4>MTsS Al-Zaytun</h4>
				...
				<div class="w3ls_footer_grid">
					<div class="col-md-4 w3ls_footer_grid_left">
						...
						<div class="w3ls_footer_grid_leftr">
							<h4>Location</h4>
							<p>16514 Cinere, West Java, INA</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="col-md-4 w3ls_footer_grid_left">
						...
						<div class="w3ls_footer_grid_leftr">
							<h4>Email</h4>
							<a href="mailto:kusnandartoni@gmail.com">kusnandartoni@gmail.com</a>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="col-md-4 w3ls_footer_grid_left">
